function histogram_all_burst(length_all_elec_sg,length_all_elec_fg,Monkey_num,bin_num)
    ...
    [count,edegs]=histcounts(length_all_elec_sg,bin_num,'Normalization','probability');
    [count2,edegs2]=histcounts(length_all_elec_fg,bin_num,'Normalization','probability');
    bin_centers_sg=(edegs(1:end-1)+edegs(2:end))/2;
    bin_centers_fg=(edegs2(1:end-1)+edegs2(2:end))/2;
