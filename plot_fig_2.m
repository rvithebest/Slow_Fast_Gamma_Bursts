...
for Monkey_num=1:2
    ...
    % title('B');
    if Monkey_num==1
        save('MP_results__M1_fig_2.mat','median_gatherer_sg','median_gatherer_fg','power_gatherer_sg','power_gatherer_fg');
    elseif Monkey_num==2
        save('MP_results__M2_fig_2.mat','median_gatherer_sg','median_gatherer_fg','power_gatherer_sg','power_gatherer_fg');
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
