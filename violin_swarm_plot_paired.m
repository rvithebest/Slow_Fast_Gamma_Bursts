function violin_swarm_plot_paired(median_gatherer_sg,median_gatherer_fg)
    ...
    % boxchart(data)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 2-sample unpaired t-tests
    [h,p,ci,stats]=ttest(median_gatherer_sg,median_gatherer_fg,'Alpha',0.05,'Tail','both');
