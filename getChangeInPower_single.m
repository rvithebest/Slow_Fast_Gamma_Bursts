...
function diffPower = getChangeInPower_single(analogData,timeVals,stimulusPeriod,baselinePeriod,gammaRange)
...
% Get Mean FFTs
mFFTst = (abs(fft(analogData(:,tPosSt),[],2)));
mFFTbl = (abs(fft(analogData(:,tPosBl),[],2)));
