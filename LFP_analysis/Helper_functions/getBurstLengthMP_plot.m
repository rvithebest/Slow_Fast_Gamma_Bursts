function [lengthList,freqList,timeList,gaborInfo,header,modList] = getBurstLengthMP_plot(analogData,timeVals,thresholdFactor,displayFlag,stimulusPeriodS,baselinePeriodS,burstFreqRangeHz,maxIteration,adaptiveDictionaryParam,dictionarySize,gaborInfo,header,plotHandles_4)
