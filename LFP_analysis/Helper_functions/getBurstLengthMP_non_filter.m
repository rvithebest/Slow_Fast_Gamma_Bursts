function [lengthList,freqList,timeList,gaborInfo,header,modList] = getBurstLengthMP_non_filter(analogData,timeVals,thresholdFactor,displayFlag,stimulusPeriodS,baselinePeriodS,burstFreqRangeHz,maxIteration,adaptiveDictionaryParam,dictionarySize,gaborInfo,header,sub_idx)
...
if isempty(gaborInfo)
    ...
    [gaborInfo,header] = getStochasticDictionaryMP3p1(analogData,timeVals,maxIteration,adaptiveDictionaryParam,dictionarySize,sub_idx);
end
